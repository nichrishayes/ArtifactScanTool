    ...
    if ~isempty(output_trial_fnames_remove)
        ...
        if any(...
                logical(...
                    cell2mat(...
                        cellfun(...
                        @(SSS) ~exist(fullfile(SSS,'brainstormstudy.mat._v1'),'file'), ...
            ...
            % then copy
            cellfun(@(SSS) copyfile(fullfile(SSS,'brainstormstudy.mat'), fullfile(SSS,'brainstormstudy.mat._v1')),...
                uniq_sub_data_mats(...
                    logical(...
                        cell2mat(...
                            cellfun(...
    ...
    if ~isempty(output_channel_names_remove)
        ...
        if any(...
                logical(...
                    cell2mat(...
                        cellfun(...
                        @(SSS) ~exist(fullfile(SSS,'AST_ChannelFlag.mat._v1'),'file'), ...
                        uniq_sub_data_mats, 'UniformOutput', false)...
                    )...
                )...
            )
            ...
            % then save a copy
            cellfun(@(SSS) backup_channel_flags(fullfile(SSS,'AST_ChannelFlag.mat._v1'), output_channel_flags),...
                uniq_sub_data_mats(...
                    logical(...
                        cell2mat(...
                            cellfun(...
